...
| 김대호 | 웹 크롤링(FAQ·차량 이미지) / 크롤링 데이터 정제·DB 적재 / AI 상담 챗봇 설계·구현 / MySQL·Vector DB RAG 연동| [![Profile](https://img.shields.io/badge/Profile-181717?logo=github&logoColor=white)](https://github.com/jjhok6389) |
